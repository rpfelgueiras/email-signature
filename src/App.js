...
export default function App() {
  ...
  const [phoneNumber, setPhoneNumber] = useState("+49 (0)711 899898-00");
  ...
  const [imageMarketingClickLink, setImageMarketingClickLink] = useState("#");
  ...
  function onChangeMarketingImageAnchorLink(event) {
    setImageMarketingClickLink(event.target.value);
  }
              ...
              <div className="isolate -space-y-px rounded-md shadow-sm">
                ...
                <div className="relative border border-gray-300 rounded-md rounded-t-none rounded-b-none px-3 py-2 focus-within:z-10 focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                  ...
                  <input
                    ...
                    className="block w-full border-0 p-0 text-gray-900 placeholder-gray-500 focus:ring-0 sm:text-sm"
                    placeholder="+49 (0)711 899898-00"
                    onChange={onChangePhoneNumber}
                    disabled={!hasPhoneNumber}
                    defaultValue={"+49 (0)711 899898-00"}
                  />
                </div>
                <div className="relative border border-gray-300 rounded-md rounded-t-none rounded-b-none px-3 py-2 focus-within:z-10 focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                  <label
                ...
                <div className="relative border border-gray-300 rounded-md rounded-b rounded-t-none px-3 py-2 focus-within:z-10 focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                  ...
                  <input
                    type="text"
                    name="marketingphotolink"
                    id="marketingphotolink"
                    data-testid="marketingphotolink"
                    className="block w-full border-0 p-0 text-gray-900 placeholder-gray-500 focus:ring-0 sm:text-sm"
                    placeholder="#"
                    onChange={onChangeMarketingImageAnchorLink}
                    disabled={!useMarketingImageUrl}
                  />
                </div>
              </div>
